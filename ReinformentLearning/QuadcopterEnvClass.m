classdef QuadcopterEnvClass < rl.env.MATLABEnvironment
    ...
    properties
        % Initialize system state [roll, p, pitch, q]'
        State = zeros(4,1)
    end
    ...
    methods              
        ...
        function this = QuadcopterEnvClass()
            % Initialize Observation settings
            ObservationInfo = rlNumericSpec([4 1]);
            ObservationInfo.Name = 'Quadcopter Attitute States';
            ObservationInfo.Description = 'roll, p, pitch, q';
            
            % Initialize Action settings   
            ActionInfo = rlFiniteSetSpec([-2 2]);
            ActionInfo.Name = 'Quadcopter Attitute Action';
        ...
        function InitialObservation = reset(this)
            ...
            InitialObservation = [pitch_0;q_0;roll_0;p_0];
